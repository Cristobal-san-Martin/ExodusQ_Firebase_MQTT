...
public class Persona_Read extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.persona_view);
        ...
        try{
            ...
            final  ArrayList<Persona_Values> lista = new ArrayList<Persona_Values>();

            if(c.moveToFirst())
            {
                do{
                    Persona_Values persona = new Persona_Values();
            ...
            lst1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, android.view.View view, int position, long l) {
                    Persona_Values persona = lista.get(position);
                    Intent i = new Intent(getApplicationContext(), Persona_Edit.class);
