...
public class Persona_Edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.persona_edit);
        ...
        b_volver.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View view) {
                Intent i = new Intent(getApplicationContext(), Persona_Read.class);
                startActivity(i);
            }
        });
    }
    ...
    public void eliminar()
    {
        try
        {
            ...
            statement.execute();
            Toast.makeText(this,"Persona eliminada de la base de datos.",Toast.LENGTH_LONG).show();
    ...
    public void editar()
    {
        try
        {
            ...
            statement.execute();
            Toast.makeText(this,"Persona actualizada en la base de datos.",Toast.LENGTH_LONG).show();
